...
public:
	...
	// adds a new frame, and creates point & residual structs.   投影点构造残差
...
private:
	...
	std::vector<FrameShell*> allFrameHistory;	//是FrameShell的一串序列  保存中历史所有Frameshell
